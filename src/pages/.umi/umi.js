...
import findRoute, {
  getUrlQuery,
} from '/Users/amazingpiggy/projects/github/multipage_antdpro/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3000,
      path: '/Users/amazingpiggy/projects/github/multipage_antdpro',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
